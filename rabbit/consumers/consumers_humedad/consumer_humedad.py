...
# Crear un canal exclusivo llamado "humedad"
channel.queue_declare(queue='humedad')

# Configurar el callback para recibir mensajes
channel.basic_consume(queue='humedad', on_message_callback=callback, auto_ack=True)

# Iniciar la recepción de mensajes
print('Esperando mensajes de humedad. Presiona CTRL+C para salir.')
